...
export function useHttp<T extends schemas>({ link, method, store, body, headers, isLazy, delay, periodic, dependsOn }: IUseHttp): HttpReturnType<T> {
