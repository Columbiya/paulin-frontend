...
export const CreatePartner: React.FC<CreatePartnerProps> = ({ onHide, setSuccess }) => {
    const { register, handleSubmit, formState: { errors }, reset } = useForm<CreatePartnerValues>()
