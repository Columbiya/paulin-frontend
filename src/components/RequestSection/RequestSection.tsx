...
export const RequestSection: React.FC<RequestSectionProps> = ({ isPopup, onHide, isAudit }) => {
        ...
        <section className={"request " + popupClasses}>
            <div className="container">
                <h2 className="education__title" data-aos={isPopup ? "": "fade-right"}>
                    ...
                    {isAudit && 
                        <span className="education__subtitle">и узнайте: нужна ли вам финансовая модель</span>
                    }
                </h2>
            ...
            <div className="request__bg mobile" style={isAudit ? {top: 100}: undefined}>
                <img src={requestBgMobile} alt="" />
            </div>
            <img src={requestPersonMobile} className="request__person mobile" alt="" style={isAudit ? {top: 100}: undefined} />
        </section>
    )
}