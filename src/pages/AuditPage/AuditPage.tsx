      ...
      <section className="audit-main-screen">
        <div className="container">
          <div className="audit-main-screen__content">
            <h1 className="audit-main-screen__title">
              Расчет финансовой модели для вашего бизнеса
            </h1>
            <p className="audit-main-screen__text">
              О каких точках извлечения прибыли вы даже не догадывались...
            </p>
        ...
        <object
          data={mainScreenBgMobile}
          className="audit-main-screen__bg mobile"></object>
        <object
          data={mainScreenPerson}
          className="audit-main-screen__person"></object>
        <object
          data={personLoop}
          className="audit-main-screen__person-loop"></object>
      </section>

      <YouCan large>
        Мы работаем так, чтобы наши клиенты смогли увидеть реальное состояние
        компании, и научились в последующем самостоятельно принимать правильные
        управленческие решения.
      </YouCan>

      <section className="why-we">
        <div className="container">
          <h2 className="why-we__title" data-aos="fade-up">
            Почему мы?
          </h2>
          ...
          <div className="why-we__items">
            <div className="why-we__item why-item" data-aos="fade-up">
              ...
              <p className="why-item__text">
                Мы сохраняем коммерческую тайну, и не раскрываем третьим лицам
            ...
            <div className="why-we__item why-item" data-aos="fade-up">
              ...
              <p className="why-item__text">
                По итогу вы получаете оцифрованный существующий бизнес или план
                нового проекта в цифрах.
              </p>
            </div>
            <div className="why-we__item why-item" data-aos="fade-up">
              <img src={graduationHatImage} alt="lock" />
              <h4 className="why-item__title">
                Заботимся, чтобы вы приобрели навык
              </h4>
              <p className="why-item__text">
                Мы заинтересованы, чтобы клиент научился работать с инструментом
                «Финансовая модель» и смог самостоятельно ее применять.
              </p>
            </div>
          </div>
          ...
          <div className="why-you-need__items">
            <div className="you-need__item" data-aos="fade-up">
              ...
              <div className="you-need__text" data-aos="fade-up">
                ...
                <p className="why-item__text">
                  Вы поймете, что происходит сейчас в компании с точки зрения
                  цифр
                </p>
              </div>
            </div>
            <div className="you-need__item" data-aos="fade-up">
              ...
              <div className="you-need__text" data-aos="fade-up">
                <h4 className="why-item__title">
                  Понятный план достижения финансовой цели
                </h4>
                <p className="why-item__text">
                  Вы сформируете план по выручке и показателям на год вперед и
                  определите стратегию его достижения.
                </p>
              </div>
            </div>
            <div className="you-need__item" data-aos="fade-up">
              ...
              <div className="you-need__text" data-aos="fade-up">
                ...
                <p className="why-item__text">
                  Вы поймете какие вам нужны показатели, чтобы ваш бизнес
                  достигал тех целей, которые вы хотите.
                </p>
              </div>
            </div>
            <div className="you-need__item" data-aos="fade-up">
              ...
              <div className="you-need__text" data-aos="fade-up">
                <h4 className="why-item__title">
                  Понимание, от чего зависит ваша прибыль
                </h4>
                <p className="why-item__text">
                  Вы поймете на чем вам нужно сэкономить, а во что вкладывать
                  деньги.
                </p>
              </div>
            </div>
        ...
        <div className="what-you-get__items">
          <div className="get__item" data-aos="fade-up">
            ...
            <div className="get__text" data-aos="fade-up">
              ...
              <p>
                Вы поймете из чего состоит ваша выручка, а главное как на нее
                оказывать влияние.
              </p>
            </div>
          </div>
          <div className="get__item" data-aos="fade-up">
            ...
            <div className="get__text" data-aos="fade-up">
              ...
              <p>
                Вы проследите взаимосвязь между этими тремя показателями и
                проверите, где вы допускаете управленческие ошибки.
              </p>
            </div>
          </div>
          <div className="get__item" data-aos="fade-up">
            ...
            <div className="get__text" data-aos="fade-up">
              ...
              <p>
                Исходя из ваших целей поймете, когда может быть кассовый разрыв
                и сможете заранее подстраховаться.
              </p>
            </div>
          </div>
          <div className="get__item" data-aos="fade-up">
            ...
            <div className="get__text" data-aos="fade-up">
              ...
              <p>
                Вы узнаете стоимость вашего бизнеса, сколько денег заморожено в
                бизнесе, и в чем они заморожены.{' '}
              </p>
            </div>
          </div>
          <div className="get__item" data-aos="fade-up">
            ...
            <div className="get__text" data-aos="fade-up">
              ...
              <p>
                Вы увидите реальный уровень необходимости в финансах для вашей
                компании.
              </p>
            </div>
          </div>
          <div className="get__item" data-aos="fade-up">
            ...
            <div className="get__text" data-aos="fade-up">
              ...
              <p>
                Вы получаете список действий, с помощью которых достигаете целей
                компании.
              </p>
            </div>
          </div>
