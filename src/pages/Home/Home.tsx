...
export const Home: React.FC<HomeProps> = ({ setActive }) => {
  ...
  const [itemsPartners, loadingPartners, errorPartners] = useHttp<Partner[]>({
    link: '/partners',
    method: Methods.GET,
    store: partnersStore,
    useAuth: false,
  ...
  return (
    <>
      <main>
        <object
          data={mainScreenImage}
          className="main-screen__image desktop"
          type="image/svg+xml"></object>
        <object
          data={bgMainScreenMobile}
          className="main-screen__image mobile"></object>
        <object
          data={personOnCircleMobile}
          className="main-screen__person-on-circle mobile"></object>
        <object
          data={personWithScreensMobile}
          className="main-screen__person-with-screens mobile"></object>
        <object
          data={personWithLaptopClock}
          className="main-screen__person-laptop"></object>
        <div className="main-screen">
          <div className="container">
            <div className="main-screen__inner">
              ...
              <h3 className="main-screen__subsubtitle">
                Внедрение инструментов управления в бизнес
              </h3>
        ...
        <div className="container" data-aos="zoom-in">
          <h2 className="about-us__title">
            Paulin Consulting - консалтинговая компания, которая помогает
            предпринимателям организовать работу бизнеса так, чтобы он приносил
            больше денег и им было легче управлять.
          </h2>
        </div>
        ...
        <div
            ...
            <div className="about-us__info" data-aos="fade-right">
              <div className="about-us__item">
                ...
                <p className="about-us__text">
                  Более 5 лет опыта в сфере бизнес-консалтинга
                </p>
              </div>
              <div className="about-us__item" data-aos="slide-right">
                <p className="text-gradient">{'>100'}</p>
                <p className="about-us__text">
                  Более 100 клиентов, с которыми работали наши эксперты
                </p>
              </div>
            </div>
          </div>
          ...
          <object
            ...
            className="bike-image"></object>
          <object
            data={bgGreenMobile}
            className="bike-image-mobile abous-us__bg mobile"></object>
          <object
            data={bikeMobile}
            className="bike-image-mobile about-us__bike mobile"></object>
          ...
          <div className="container">
            <header className="business-consulting__header">
              <div data-aos="fade-right">
                ...
                <h3 className="business-consulting__subtitle">
                  Мы делаем из бизнеса систему
                </h3>
              </div>
            ...
            <p className="business-consulting__text" data-aos="fade-in">
              Программа по внедрению инструментов управления в действующий
              бизнес, которая включает разработку и внедрение:
            </p>
          </div>
        </div>
            ...
            <div className="features__inner">
              <div className="features__left">
                ...
                <div className="features__item small">
                  ...
                  <p data-aos="fade-in">системы управления финансами</p>
                </div>
              </div>
        ...
        <div className="education">
          <div className="container">
            <div className="education__inner">
              <h2 className="education__title" data-aos="fade-right">
                Обучение экспертов
              </h2>
              <p className="education__text" data-aos="fade-right">
                Онлайн школа по обучению экспертов инструментам управления
                бизнесом, которые внедряются в компаниях клиентов Paulin
              </p>

              <div className="education__buttons" data-aos="fade-right">
                <Button isGradientBordersWithWhiteBack soon>
                  Подробнее
                </Button>
                <Button isFilled onClick={() => setActive(true)}>
