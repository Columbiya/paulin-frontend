...
export const BusinessConsulting: React.FC<BusinessConsultingProps> = ({
  setActive,
}) => {
  const [items, loading, error] = useHttp<News[]>({
    link: '/news',
    method: Methods.GET,
    store: newsStore,
    useAuth: false,
  ...
  return (
    <main>
      <div className="consulting-main-screen">
        ...
        <object
          data={personCheck}
          className="consulting__person-check"></object>
        <object
          data={layersMobile}
          className="consulting__layers-mobile"></object>

        <div className="consulting-main-screen__content">
          <div className="container">
            <h1 className="consulting__title">Smart Business</h1>
            <h2 className="consulting__subtitle">
              Свобода начинается за барьерами
            </h2>
            <Button isFilled onClick={() => setActive(true)}>
              Отправить заявку
            </Button>
          </div>
        </div>
          ...
          <div className="business__tools">
            <div className="tool__item" data-aos="fade-in">
              ...
              <p className="tool__text">
                Действия членов команды будут согласованы
              </p>
            </div>
            <div className="tool__item" data-aos="fade-in">
              <img
              ...
              <p className="tool__text">
                Новых сотрудников будет легче ввести в должность
              </p>
            </div>
            <div className="tool__item" data-aos="fade-in">
              <img
              ...
              <p className="tool__text">
                Сотрудники будут четко знать свои функции
              </p>
            </div>
            <div className="tool__item" data-aos="fade-in">
              <img
              ...
              <p className="tool__text">
                Вы сможете отследить насколько продуктивны ваши сотрудники
              </p>
            </div>
            <div className="tool__item" data-aos="fade-in">
              ...
              <p className="tool__text">
                Вы будете знать, чем занимаются сотрудники каждый день и
                прогнозировать, когда придете к цели
              </p>
            </div>
            <div className="tool__item" data-aos="fade-in">
              <img
              ...
              <p className="tool__text">
                Эффективное взаимодействие членов команды: задачи не потеряются
                и будут выполнены
              </p>
            </div>
            <div className="tool__item" data-aos="fade-in">
              ...
              <p className="tool__text">
                Сотрудники будут знать, ради чего они работают и куда движется
                компания
              </p>
            </div>
            <div className="tool__item" data-aos="fade-in">
              ...
              <p className="tool__text">
                Руководители будут сами распоряжаться финансами и распределять
                их более осмысленно
              </p>
            </div>
            <div className="tool__item" data-aos="fade-in">
              ...
              <p className="tool__text">
                Вы сможете составить план дальнейшего развития компании
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="business__helps-you">
        <div className="container">
          <div className="helps-you__inner">
            <h4 className="helps-you__title" data-aos="fade-right">
              Эти инструменты помогут создать систему эффективного бизнеса.
            </h4>
            <p className="helps-you__text" data-aos="fade-right">
              У вас появится сильная команда, которая возьмет на себя
              исполнительные задачи, а у вас будет больше свободного времени,
              чтобы заниматься только своими прямыми обязанностями
            </p>
          </div>
        </div>
      ...
      <div className="business__our-clients our-clients">
        <div className="container">
          <h4 className="our-clients__title" data-aos="fade-right">
            К нам обращаются владельцы бизнеса, которые хотят решить следующие
            проблемы:
          </h4>
          ...
          <div className="our-clients__inner">
            <div className="our-clients__item" data-aos="zoom-in">
              ...
              <ul className="our-clients__list list wrong">
                <li data-aos="fade-up">Кассовые разделы</li>
                <li data-aos="fade-up">Отсутствие дивидендов у владельцев</li>
                <li data-aos="fade-up">
                ...
                <li data-aos="fade-up">Большой ФОТ</li>
                <li data-aos="fade-up">
            ...
            <div className="our-clients__item" data-aos="zoom-in">
              ...
              <ul className="our-clients__list list wrong">
                ...
                <li data-aos="fade-up">Нет понимания "когда пора увольнять"</li>
                <li data-aos="fade-up">
                  Нет понимания "кто за что отвечает" - ни у владельца, ни у
                  сотрудника
                </li>
                <li data-aos="fade-up">
      ...
      <div className="responsibility">
        <div className="container">
          <h4 className="responsibility__title" data-aos="fade-right">
          ...
          <div className="responsibility__inner">
            <div className="responsibility__item" data-aos="fade-up">
              <object
                data={personWithCart}
                className="responsibility__image"></object>
            ...
            <div className="responsibility__item" data-aos="fade-up">
              <object
                data={personWithRocket}
                className="responsibility__image"></object>

              <h5 className="responsibility__subtitle">ПОСЛЕ систематизации</h5>
              <ul className="our-clients__list list right">
                <li data-aos="fade-up">Работа над стратегией компании</li>
                <li data-aos="fade-up">
                  Обслуживание клиентов: заключение договоров, презентация
                  товаров и услуг
                </li>
                <li data-aos="fade-up">
                  Найм сотрудников: поиск кандидатов, проведение собеседований,
                  введение в должность
                </li>
                <li data-aos="fade-up">
                  Производство продукта: от составления технического задания до
                  упаковки
                </li>
                <li data-aos="fade-up">
                  Разработка рекламных кампаний: генерация идей для привлечения
                  клиентов, создание рекламных материалов, анализ показателей
                </li>
                <li data-aos="fade-up">
                  Вести соцсети компании: писать посты, делать Stories, общаться
                  с подписчиками
                </li>
              </ul>
            </div>
          ...
          <img
            ...
            className="responsibility__bg"
            alt=""
          />
        </div>
      </div>

      <YouCan text="Вы сможете автоматизировать бизнес во время прохождения годовой программы по внедрению системы управления" />
